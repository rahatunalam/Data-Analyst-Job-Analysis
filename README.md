This project explores a dataset of over 30,000 Data Analyst job postings collected via Google Search. The analysis focuses on salary trends, top hiring companies, in-demand skills, and the distribution of job types (Remote vs. On-site).
📊 Project Overview
